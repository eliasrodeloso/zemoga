...
const PreviousRuler = ({ ruler }) => {
  const [isFetchingImage, setImageFetching] = useState(true);
  const [imagePath, setImagePath] = useState('');
  useEffect(() => {
    import(`../../assets/images/${ruler.picture}`).then((path) => {
